...
const ABOUT_TEXT =
  "As a computer science student, i focus on full-stack development, databases, and problem-solving, i truly enjoy building projects that are practical, well-structured, and genuinely useful, from case-management platforms to freelance marketplaces. Let's build something incredible together!";
